...
\newcommand{\KappaRG}{\tfrac{1}{2}\ \text{(exact)}} % [A] exact RG fixed-point input; not an empirical pm
%===================================================================
...
ONT-06 & $\kappa = \KappaRG$ RG fixed-point input; the constraint $5\kappa^2 = 3\lambda_S$ closes internally to a residual $<10^{-14}$. The empirically calibrated reading $\kappa = 0.500 \pm 0.008$ is a separate, lower-class statement and is not the basis of this row. & \catmark{A} & II \\
