...
Conformal Density Mapping; Renormalization Group Cascade; Infrared Stability
\end{abstract}
...
\begin{tcolorbox}[
    ...
    boxrule=0pt,
    arc=2pt,
    drop shadow={opacity=0.04, shadowxshift=1pt, shadowyshift=1pt},
    width=0.95\textwidth,
...
\input{sections/ir_fixpoint_stability.tex}
...
\begin{enumerate}
    ...
    The Planck singularity is addressed by the 99-step RG cascade, with
